...
(function () {
  ...
  function createEmbed() {
    // Nunca dos reproductores: si ya hay uno (lo acaba de montar el sitio, o un repaso anterior),
    // no se toca (dos `<embed>` = dos instancias de Ruffle cargando el mismo juego).
