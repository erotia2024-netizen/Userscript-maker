...
(function () {
  ...
  function emptyZones() {
    ...
    qa("#topzone").forEach(function (zone) {
      ...
      zone.classList.toggle("hf-ad-empty", !painted && !shows && (frames.length > 0 || vacia));
    });
