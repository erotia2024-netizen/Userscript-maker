...
(function () {
  ...
  function animo(s) {
    ...
    if (muy(t)) return { id: "nerviosa", titulo: "Nerviosa", txt: "rubor, gotas y un temblor", rubor: 0.45, corazones: 0, brillo: 0.2, tiembla: true, gota: true };
    ...
    if (algo(t)) return { id: "tensa", titulo: "Tensa", txt: "un poco de rubor", rubor: 0.35, corazones: 0, brillo: 0.15, tiembla: false };
  ...
  function retrato(s) {
    ...
    var ajuste = s.cara || (s.cara = { y: 52, x: 15 });
    ...
    varon(cara, "--em-cara-y", (Number(ajuste.y) || 52) + "%");
  ...
  function moverCara(dy, dx) {
    var s = ficha();
    if (!s) return;
    var c = s.cara || (s.cara = { y: 52, x: 15 });
    c.y = Math.max(20, Math.min(86, (Number(c.y) || 52) + dy));
