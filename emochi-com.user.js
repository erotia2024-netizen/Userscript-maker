...
(function () {
  ...
  function retrato(s) {
    ...
    var capas = [el("img", { class: "em-cara-img", src: url, alt: "Retrato del bot" })];
    capas.push(el("i", { class: "em-brillo", style: { opacity: String(a.brillo || 0) } }));
    if (a.rubor) {
